...
main = do
  ...
  print(triangularNumber [1, 9])
  print(triangularNumber [2, 9])
  print(triangularNumber [3, 9])
  print(triangularNumber [4, 9])
  print(triangularNumber [5, 9])
  print(triangularNumber [6, 9])
  print(triangularNumber [7, 9])
  print(triangularNumber [8, 9])
  print(triangularNumber [9, 9])
  print(triangularNumber [10, 9])
